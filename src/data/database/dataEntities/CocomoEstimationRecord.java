...
public class CocomoEstimationRecord extends Entity{
	...
	public HashMap<String, String> getFactors() {
		...
		factors.put("PREC", getPREC());
		factors.put("FLEX", getFLEX());
		factors.put("RESL", getRESL());
		factors.put("TEAM", getTEAM());
		factors.put("PMAT", getPMAT());
		factors.put("RELY", getRELY());
		factors.put("DATA", getDATA());
		factors.put("CPLX", getCPLX());
		factors.put("RUSE", getRUSE());
		factors.put("DOCU", getDOCU());
		factors.put("TIME", getTIME());
		factors.put("STOR", getSTOR());
		factors.put("PVOL", getPVOL());
		factors.put("ACAP", getACAP());
		factors.put("PCAP", getPCAP());
		factors.put("PCON", getPCON());
		factors.put("APEX", getAPEX());
		factors.put("PLEX", getPLEX());
		factors.put("LTEX", getLTEX());
		factors.put("TOOL", getTOOL());
		factors.put("SITE", getSITE());
		factors.put("SCED", getSCED());
		factors.put("RCPX", getRCPX());
		factors.put("PDIF", getPDIF());
		factors.put("PERS", getPERS());
		factors.put("PREX", getPREX());
		factors.put("FCIL", getFCIL());
		return factors;
	}
