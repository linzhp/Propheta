...
public class CocomoSizeEstimation_maintained_Page extends BaseWizardPage{
	...
	protected int getSize() {
		...
		// new code
		CocomoSizeEstimation_newDeveloped_Page new_Page=seWizard.getCocomoSizeEstimation_newDeveloped_Page();
